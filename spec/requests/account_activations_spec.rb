...
RSpec.describe 'Account Activations', type: :request do
  ...
  describe 'POST/sessions' do
    ...
    context 'when account is not activated' do
      let(:user) { User.create(name: 'Andreea', email: 'andreea@gmail.com', password: '123456', password_confirmation: '123456')}
    ...
    context 'when account is activated' do 
      let(:user) { User.create(name: 'Andreea', email: 'andreaexample1@gmail.com', password: '123456', password_confirmation: '123456', activated: true, activated_at: Time.now )}
